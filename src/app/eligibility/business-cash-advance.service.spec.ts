...
describe('BusinessCashAdvanceService', () => {
  ...
  it('should return false when input data invalid', inject([BusinessCashAdvanceService], (service: BusinessCashAdvanceService) => {
    const inputData = {
    ...
    expect(service.checkEligibility(inputData)).toEqual(false);
  }));

  it('should return true when input data valid', inject([BusinessCashAdvanceService], (service: BusinessCashAdvanceService) => {
    const inputData = {
      amountRequested: 45000,
      timeInBusiness: {
        years: 0,
